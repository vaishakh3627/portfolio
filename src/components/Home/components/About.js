      ...
      <Row>
        ...
        <Col xs={12} className="text-center">
          <q>
            ...
            focused on developing scalable and well documented code. I enjoy
        ...
        <Col xs={12} className="about-details">
          <Row>
            ...
            >
              <img src={Mine} alt="vaishakh" className="image-content" />
            </Col>
            <Col lg={8} md={12} sm={12} className="mt-4">
              <Row>
                ...
                <Col lg={6} md={6} sm={12} className="mt-2 px-4">
                  <GrFormNext />
                ...
                <Col lg={12} md={12} sm={12} className="mt-4 px-4">
                  <p>
